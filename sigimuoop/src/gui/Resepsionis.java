...
public class Resepsionis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Resepsionis Sigimu");

        jButton1.setText("Periksa ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int _idpasien = Integer.parseInt(jTextField1.getText().toString());
        try {
            System.out.println(resepsionis_.checkdaftar(new Pasien(_idpasien)));
        } catch (Exception ex) {
            Logger.getLogger(Resepsionis.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            if(!resepsionis_.checkdaftar(new Pasien(_idpasien)))
    ...
    private sigimu.Resepsionis resepsionis_;
}
